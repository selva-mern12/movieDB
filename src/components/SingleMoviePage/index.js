...
class SingleMoviePage extends Component {
  state = {
    movieDetails: {},
    castCrewDetails: {},
    moviePageStatus: pageStatus.initial,
  }
  ...
  getMovieDetails = async () => {
    this.setState({moviePageStatus: pageStatus.loading})
    ...
    if (responseMovie.ok && responseCastAndCrew.ok) {
      ...
      this.setState({
        ...
        castCrewDetails: updatedDataCast,
        moviePageStatus: pageStatus.success,
      })
    } else {
      this.setState({moviePageStatus: pageStatus.failure})
    }
  }

  renderSingleMoviePage = () => {
    const {movieDetails, castCrewDetails, moviePageStatus} = this.state
